...
goog.provide('proto.sisyphus.DeletePatternRequest');
goog.provide('proto.sisyphus.DeletePatternResponse');
goog.provide('proto.sisyphus.GetLedIntensityRequest');
goog.provide('proto.sisyphus.GetLedIntensityResponse');
goog.provide('proto.sisyphus.GetPatternsRequest');
goog.provide('proto.sisyphus.GetPatternsResponse');
goog.provide('proto.sisyphus.InsertPatternRequest');
goog.provide('proto.sisyphus.InsertPatternResponse');
...
goog.provide('proto.sisyphus.SetLedIntensityRequest');
goog.provide('proto.sisyphus.SetLedIntensityResponse');
...
proto.sisyphus.InsertPatternRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    pattern: (f = msg.getPattern()) && proto.sisyphus.StoredPattern.toObject(includeInstance, f),
...
proto.sisyphus.InsertPatternRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.sisyphus.StoredPattern;
      reader.readMessage(value,proto.sisyphus.StoredPattern.deserializeBinaryFromReader);
...
proto.sisyphus.InsertPatternRequest.prototype.serializeBinaryToWriter = function (writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.sisyphus.StoredPattern.serializeBinaryToWriter
    );
  }
  f = /** @type {number} */ (jspb.Message.getField(this, 2));
  if (f != null) {
...
proto.sisyphus.InsertPatternRequest.prototype.getPattern = function() {
  return /** @type{?proto.sisyphus.StoredPattern} */ (
    jspb.Message.getWrapperField(this, proto.sisyphus.StoredPattern, 1));
};
...
proto.sisyphus.GetPatternsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.sisyphus.StoredPattern.toObject, includeInstance),
...
proto.sisyphus.GetPatternsResponse.prototype.getUpcomingPatternsList = function() {
  return /** @type{!Array.<!proto.sisyphus.StoredPattern>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.sisyphus.StoredPattern, 1));
};
...
proto.sisyphus.GetPatternsResponse.prototype.getPastPatternsList = function() {
  return /** @type{!Array.<!proto.sisyphus.StoredPattern>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.sisyphus.StoredPattern, 2));
};
